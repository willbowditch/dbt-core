...
class TestDocs(DBTIntegrationTest):
    ...
    def test_postgres_pp_docs(self):
        ...
        self.assertEqual(
            manifest.sources[source_id].source_description, "LOTS of customer data"
        )
        ...
        self.assertEqual(
            manifest.exposures[exposure_id].description, "LOTS of customer data"
        )
        ...
        self.assertEqual(model_node.description, "This table contains customer data")
        self.assertEqual(
            manifest.sources[source_id].source_description,
            "This table contains customer data",
        )
        self.assertEqual(
            manifest.macros[macro_id].description, "This table contains customer data"
        )
        self.assertEqual(
            manifest.exposures[exposure_id].description,
            "This table contains customer data",
        )
