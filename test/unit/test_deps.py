...
class TestHubPackage(unittest.TestCase):
    def setUp(self):
        ...
        self.get_available_versions.return_value = ["0.1.2", "0.1.3", "0.1.4a1"]
...
class TestPackageSpec(unittest.TestCase):
    def setUp(self):
            ...
            packages={
                ...
                "dbt-labs-test/b": {
                    "0.2.1": {
                        ...
                        "version": "0.2.1",
                        "packages": [
                            {"package": "dbt-labs-test/a", "version": ">=0.1.3"}
                        ],
                        "_source": {
                            "blahblah": "asdfas",
                        },
        ...
        self.registry.get_available_versions.side_effect = (
            self.mock_registry.get_available_versions
        )
