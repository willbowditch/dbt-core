...
class Union:
    ...
    def __eq__(self, other):
        ...
        return all(
            mine == theirs for mine, theirs in zip(self.components, other.components)
        )
...
class Criteria:
    ...
    def __repr__(self):
        return (
            f"Criteria(method={self.method!r}, value={self.value!r}, **{self.kwargs!r})"
        )
        ...
        Union(
            ...
            Union(
                Criteria(
                    ...
                    value="models/snowplow/marketing/custom_events.sql",
                ),
