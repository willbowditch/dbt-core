...
changed_compiled_models = [
    ...
    lambda u: (
        ...
        replace_config(
            u, persist_docs={"relation": True}, description="a model description"
        ),
    ),
...
def test_compare_to_compiled(
    basic_uncompiled_schema_test_node, basic_compiled_schema_test_node
):
