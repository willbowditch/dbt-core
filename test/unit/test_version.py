...
class VersionTest(unittest.TestCase):
    ...
    def test_get_adapter_plugin_names(self, mock_find_spec, mock_glob):
        ...
        mock_submodule.submodule_search_locations = [
            "/tmp/dbt/plugins/postgres/dbt/adapters/",
            "/tmp/dbt/plugins/snowflake/dbt/adapters/",
        ]
    ...
    def test_get_dbt_plugins_info_with_version_info(self, mock_mod, mock_get_plugin_names):
        ...
        self.assertEqual(
            list(dbt.version._get_dbt_plugins_info()), [("postgres", "1.0"), ("snowflake", "1.0")]
        )
