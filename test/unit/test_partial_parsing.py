...
class TestPartialParsing(unittest.TestCase):
    def setUp(self):
        ...
        schema_file = SchemaSourceFile(
            ...
            dfy={
                "version": 2,
                "models": [{"name": "my_model", "description": "Test model"}],
            },
            ndp=["model.my_test.my_model"],
            env_vars={},
        )
        self.saved_files = {
            model_file.file_id: model_file,
    ...
    def test_simple(self):
        ...
        self.partial_parsing.new_files[model_file_id].checksum = FileHash.from_contents(
            "xyzabc"
        )
